...
using Confetti.Domain.Core;
using Microsoft.AspNetCore.Hosting;
using Microsoft.Extensions.FileProviders;

namespace Confetti.Domain.Core.Infrastructure
{
    /// <summary>
    /// IO functions using the on-disk file system
    /// </summary>
    public class ConfettiFileProvider : PhysicalFileProvider, IConfettiFileProvider
    {
        /// <summary>
        ...
        {
            var path = env.ContentRootPath ?? string.Empty;
            if (File.Exists(path))
