...
namespace Confetti.Infrastructure.Data.EntityFrameworkCore.Mapping
{
    ...
    public abstract class ConfettiEntityTypeConfiguration<TEntity> : IMappingConfiguration, IEntityTypeConfiguration<TEntity> where TEntity : class
    {
        #region Properties
        ...
        /// </summary>
        public virtual Type ContextType => typeof(ConfettiContext);
